...
import 'package:yeyeapp_flutter/uploadScreens/items_upload_screen.dart';
import 'package:yeyeapp_flutter/widgets/items_design.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(pinned: true, delegate: TextWidgetHeader(title: widget.model!.menuInfo.toString())),
